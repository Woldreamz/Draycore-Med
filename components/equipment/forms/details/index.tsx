    ...
    <form className='w-3/4 p-6 m-auto bg-white rounded-lg shadow-md flex flex-col gap-6'>
        <FormGroup heading='Basic Information'>
            ...
            <div className='w-[97%]'>
              ...
              <textarea  id='description' className='focus:outline-teal-600 w-full h-30 resize-none' value={props.description} ></textarea>
            </div>
        </FormGroup>
        <FormGroup heading='Specifications & Keywords'>
            ...
            <div className='w-[97%]'>
              ...
              <input value={props.keywords.map((item) => item)} className='focus:outline-teal-600 rounded border border-solid w-full' type='text' id='keywords' name='keywords' />
            </div>
        </FormGroup>
    </form>
  )
